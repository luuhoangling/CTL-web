<?php
// Session is already started in config files, so we don't need to start it again
                        ...
                        <li class="nav-item me-2">
                            ...
                            <li class="nav-item dropdown" data-aos="fade-left" data-aos-duration="900">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a id="logout" class="dropdown-item text-danger" href="logout.php"><i class="bi bi-box-arrow-right me-2"></i>Đăng xuất</a></li>
                                </ul>
                            </li>
                        <?php else: ?>
